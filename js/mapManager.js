...
const mapManager = (() => {
    ...
    const buildSelectedStopWidget = (p) => {
        ...
        const content = `
            <!-- Opción Radio Taxi -->
            <div style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); border-radius: 30px; padding: 1.25rem; display: flex; flex-direction: column; gap: 0.5rem;">
                ...
                <!-- Botones de acción -->
                <div style="display: flex; gap: 0.5rem; margin-top: 0.5rem; width: 100%; flex-wrap: wrap;">
                    <a href="tel:+34956212121" style="flex: 1; min-width: 120px; display: flex; justify-content: center; align-items: center; gap: 0.4rem; background: #06b6d4; color: white; padding: 0.8rem; border-radius: 9999px; text-decoration: none; font-weight: 600; font-size: 0.95rem; border: none; box-shadow: 0 4px 15px rgba(6, 182, 212, 0.3); transition: all 0.3s ease;">
                        <i data-lucide="phone" style="width: 18px; height: 18px;"></i> Llamar
                    </a>
                    <a href="https://wa.me/34956212121" target="_blank" style="flex: 1; min-width: 120px; display: flex; justify-content: center; align-items: center; gap: 0.4rem; background: #25D366; color: white; padding: 0.8rem; border-radius: 9999px; text-decoration: none; font-weight: 600; font-size: 0.95rem; border: none; box-shadow: 0 4px 15px rgba(37, 211, 102, 0.3); transition: all 0.3s ease;">
