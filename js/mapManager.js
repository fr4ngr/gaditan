            ...
            <div style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); border-radius: 16px; padding: 1.25rem; display: flex; flex-direction: column; gap: 0.85rem;">
                <div style="display: flex; justify-content: space-between; align-items: flex-start; width: 100%;">
                    ...
                    <div style="display: flex; justify-content: flex-end; gap: 0.5rem;">
                        <a href="tel:+34956212121" style="text-decoration: none;">
                            <div class="circle-btn btn-blue" style="width: 44px; height: 44px;"><i data-lucide="phone" style="width:20px; height:20px; color: white;"></i></div>
                        </a>
                        <a href="https://wa.me/34956212121" style="text-decoration: none;">
                            <div class="circle-btn btn-green" style="width: 44px; height: 44px;">
