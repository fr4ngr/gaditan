...
function renderDestino(dest) {
    ...
    <details class="mini-dest-card native-accordion" style="margin-bottom: 1rem;">
        ...
        <div class="native-content" style="display: flex; flex-direction: column; gap: 1rem;">
                ...
                <div style="background: rgba(255,255,255,0.02); border: 1px solid rgba(99, 102, 241, 0.3); border-radius: 16px; padding: 1.25rem; display: flex; flex-direction: column; gap: 1rem;">
                    <!-- Badge -->
                    <div style="display: flex; align-items: center; gap: 0.4rem;">
                    ...
                    <a href="https://cadiz.cab" target="_blank" style="width: 100%; display: flex; justify-content: center; align-items: center; gap: 0.5rem; background: rgba(99, 102, 241, 0.15); color: white; padding: 1rem; border-radius: 9999px; margin-top: 0.5rem; text-decoration: none; font-weight: 600; font-size: 1rem; border: 1px solid rgba(99, 102, 241, 0.3); transition: all 0.3s ease;">
