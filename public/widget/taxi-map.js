...
var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, i = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, o = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), s = (e, i, o, s) => {
	...
	{
		id: "p_0",
		name: "Atlántico (Parque Genovés)",
		address: "Parador de Cádiz",
		lat: 36.5342075,
		lon: -6.3050849
	},
	{
	...
	},
	{
		id: "p_4",
		name: "Palillero",
		address: "Plaza del Palillero.",
		lat: 36.5318437,
		lon: -6.2964062
	},
	{
		id: "p_5",
		name: "Diputación (Tortugas)",
		address: "Plaza de las Tortugas",
		lat: 36.533451,
		lon: -6.293564
	},
	{
	...
	},
	{
		id: "p_7",
		name: "Comes",
		address: "Plaza de la Hispanidad",
		lat: 36.535364,
		lon: -6.291775
	},
	{
	...
	},
	{
		id: "p_10",
		name: "Estación",
		address: "Entrada Oeste de la Estación de Adif",
		lat: 36.528159,
		lon: -6.287746
	},
	{
		id: "p_11",
		name: "Caja Nacional",
		address: "Junto al Instituto Nacional de la Seguridad Social",
		lat: 36.526253,
		lon: -6.289851
	},
	{
		id: "p_12",
		name: "Monte Puerta Tierra",
		address: "Avenida Andalucía, 34",
		lat: 36.520385,
		lon: -6.285054
	},
	{
	...
	},
	{
		id: "p_14",
		name: "Corte Inglés",
		address: "Avenida de las Cortes de Cádiz",
		lat: 36.521661,
		lon: -6.276634
	},
	{
		id: "p_15",
		name: "Bar Parada",
		address: "Avenida Guadalquivir, 23",
		lat: 36.519283,
		lon: -6.277154
	},
	{
	...
	},
	{
		id: "p_19",
		name: "Residencia",
		address: "Avenida Cayetano del Toro, 1 (Hospital Puerta del Mar)",
		lat: 36.507906,
		lon: -6.27775
	},
	{
		id: "p_20",
		name: "Mercadona",
		address: "Avenida de la Ilustración, 1",
		lat: 36.507279,
		lon: -6.268245
	},
	{
		id: "p_21",
		name: "Canary",
		address: "Avenida Cayetano del Toro, 21 (Glorieta Zona Franca).",
		lat: 36.505821,
		lon: -6.276564
	},
	{
	...
	},
	{
		id: "p_23",
		name: "Piscina",
		address: "Complejo Deportivo Ciudad de Cádiz",
		lat: 36.497418,
		lon: -6.271457
	},
	{
		id: "p_24",
		name: "Zona Franca",
		address: "Glorieta de la Zona Franca",
		lat: 36.500538,
		lon: -6.268548
	}
], u = /* @__PURE__ */ c((/* @__PURE__ */ o(((e, t) => {
	(function(n, r) {
		...
		var b = 0;
		function te(e) {
			var t = +/* @__PURE__ */ new Date(), n = Math.max(0, 16 - (t - b));
			return b = t + n, window.setTimeout(e, n);
		}
		var ne = window.requestAnimationFrame || ee("RequestAnimationFrame") || te, re = window.cancelAnimationFrame || ee("CancelAnimationFrame") || ee("CancelRequestAnimationFrame") || function(e) {
			window.clearTimeout(e);
		};
		function x(e, t, n) {
			if (n && ne === te) e.call(t);
			else return ne.call(window, i(e, t));
		}
		function S(e) {
			e && re.call(window, e);
		}
		...
		C.extend = function(e) {
			...
			return e.statics && n(t, e.statics), e.includes && (ae(e.includes), n.apply(null, [a].concat(e.includes))), n(a, e), delete a.statics, delete a.includes, a.options && (a.options = i.options ? r(i.options) : {}, n(a.options, e.options)), a._initHooks = [], a.callInitHooks = function() {
		...
		w.addEventListener = w.on, w.removeEventListener = w.clearAllEventListeners = w.off, w.addOneTimeEventListener = w.once, w.fireEvent = w.fire, w.hasEventListeners = w.listens;
		var oe = C.extend(w);
		function T(e, t, n) {
		...
		var ge = document.documentElement.style, _e = "ActiveXObject" in window, ve = _e && !document.addEventListener, ye = "msLaunchUri" in navigator && !("documentMode" in document), be = F("webkit"), xe = F("android"), Se = F("android 2") || F("android 3"), Ce = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10), we = xe && F("Google") && Ce < 537 && !("AudioNode" in window), Te = !!window.opera, Ee = !ye && F("chrome"), De = F("gecko") && !be && !Te && !_e, Oe = !Ee && F("safari"), ke = F("phantom"), Ae = "OTransition" in ge, je = navigator.platform.indexOf("Win") === 0, Me = _e && "transition" in ge, Ne = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix() && !Se, Pe = "MozPerspective" in ge, Fe = !window.L_DISABLE_3D && (Me || Ne || Pe) && !Ae && !ke, Ie = typeof orientation < "u" || F("mobile"), Le = Ie && be, Re = Ie && Ne, ze = !window.PointerEvent && window.MSPointerEvent, Be = !!(window.PointerEvent || ze), Ve = "ontouchstart" in window || !!window.TouchEvent, He = !window.L_NO_TOUCH && (Ve || Be), Ue = Ie && Te, We = Ie && De, Ge = (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI) > 1, Ke = function() {
			var e = !1;
			try {
		...
		}(), Je = !!(document.createElementNS && me("svg").createSVGRect), Ye = !!Je && (function() {
		...
		function mt(e, t) {
			t.MSPOINTER_TYPE_TOUCH && t.pointerType === t.MSPOINTER_TYPE_TOUCH && q(t), pt(e, t);
		}
		function ht(e) {
			var t = {}, n, r;
		...
		function U(e, t) {
			e._leaflet_pos = t, I.any3d ? Mt(e, t) : (e.style.left = t.x + "px", e.style.top = t.y + "px");
		}
		function Nt(e) {
		...
		function W(e, t, n, r) {
			if (t && typeof t == "object") for (var i in t) Yt(e, i, t[i], n);
			else {
				t = f(t);
				for (var a = 0, o = t.length; a < o; a++) Yt(e, t[a], n, r);
			}
			return this;
		}
		var G = "_leaflet_events";
		function K(e, t, n, r) {
			if (arguments.length === 1) qt(e), delete e[G];
			else if (t && typeof t == "object") for (var i in t) Xt(e, i, t[i], n);
			else if (t = f(t), arguments.length === 2) qt(e, function(e) {
				return v(t, e) !== -1;
			});
			else for (var a = 0, o = t.length; a < o; a++) Xt(e, t[a], n, r);
			return this;
		}
		function qt(e, t) {
			for (var n in e[G]) {
				var r = n.split(/\d/)[0];
				(!t || t(r)) && Xt(e, r, null, null, n);
			}
		}
		var Jt = {
		...
		function Yt(e, t, n, r) {
			var i = t + o(n) + (r ? "_" + o(r) : "");
			if (e[G] && e[G][i]) return this;
			var a = function(t) {
				return n.call(r || e, t || window.event);
			}, s = a;
			!I.touchNative && I.pointer && t.indexOf("touch") === 0 ? a = st(e, t, a) : I.touch && t === "dblclick" ? a = _t(e, a) : "addEventListener" in e ? t === "touchstart" || t === "touchmove" || t === "wheel" || t === "mousewheel" ? e.addEventListener(Jt[t] || t, a, I.passiveEvents ? { passive: !1 } : !1) : t === "mouseenter" || t === "mouseleave" ? (a = function(t) {
				t ||= window.event, on(e, t) && s(t);
			}, e.addEventListener(Jt[t], a, !1)) : e.addEventListener(t, s, !1) : e.attachEvent("on" + t, a), e[G] = e[G] || {}, e[G][i] = a;
		}
		function Xt(e, t, n, r, i) {
			i ||= t + o(n) + (r ? "_" + o(r) : "");
			var a = e[G] && e[G][i];
			if (!a) return this;
			!I.touchNative && I.pointer && t.indexOf("touch") === 0 ? ct(e, t, a) : I.touch && t === "dblclick" ? vt(e, a) : "removeEventListener" in e ? e.removeEventListener(Jt[t] || t, a, !1) : e.detachEvent("on" + t, a), e[G][i] = null;
		}
		function Zt(e) {
			return e.stopPropagation ? e.stopPropagation() : e.originalEvent ? e.originalEvent._stopped = !0 : e.cancelBubble = !0, this;
		}
		function Qt(e) {
			return Yt(e, "wheel", Zt), this;
		}
		function $t(e) {
			return W(e, "mousedown touchstart dblclick contextmenu", Zt), e._leaflet_disable_click = !0, this;
		}
		function q(e) {
			return e.preventDefault ? e.preventDefault() : e.returnValue = !1, this;
		}
		function en(e) {
			return q(e), Zt(e), this;
		}
		function tn(e) {
		...
		function an(e) {
			return I.edge ? e.wheelDeltaY / 2 : e.deltaY && e.deltaMode === 0 ? -e.deltaY / rn : e.deltaY && e.deltaMode === 1 ? -e.deltaY * 20 : e.deltaY && e.deltaMode === 2 ? -e.deltaY * 60 : e.deltaX || e.deltaZ ? 0 : e.wheelDelta ? (e.wheelDeltaY || e.wheelDelta) / 2 : e.detail && Math.abs(e.detail) < 32765 ? -e.detail * 20 : e.detail ? e.detail / -32765 * 60 : 0;
		}
		function on(e, t) {
		...
		var sn = {
			...
			_runFrame: function(e, t) {
				...
				t && n._round(), U(this._el, n), this.fire("step");
			},
			_complete: function() {
			...
			initialize: function(e, t) {
				t = p(this, t), this._handlers = [], this._layers = {}, this._zoomBoundLayers = {}, this._sizeChanged = !0, this._initContainer(e), this._initLayout(), this._onResize = i(this._onResize, this), this._initEvents(), t.maxBounds && this.setMaxBounds(t.maxBounds), t.zoom !== void 0 && (this._zoom = this._limitZoom(t.zoom)), t.center && t.zoom !== void 0 && this.setView(M(t.center), t.zoom, { reset: !0 }), this.callInitHooks(), this._zoomAnimated = bt && I.any3d && !I.mobileOpera && this.options.zoomAnimation, this._zoomAnimated && (this._createAnimProxy(), W(this._proxy, xt, this._catchTransitionEnd, this)), this._addLayers(this.options.layers);
			},
			...
			flyTo: function(e, t, n) {
				...
				var ee = Date.now(), b = (f(1) - g) / u, te = n.duration ? 1e3 * n.duration : 1e3 * b * .8;
				function ne() {
					var n = (Date.now() - ee) / te, a = y(n) * b;
					n <= 1 ? (this._flyToFrame = x(ne, this), this._move(this.unproject(r.add(i.subtract(r).multiplyBy(v(a) / l)), o), this.getScaleZoom(s / _(a), o), { flyTo: !0 })) : this._move(e, t)._moveEnd(!0);
				}
				return this._moveStart(!0, n.noMoveStart), ne.call(this), this;
			},
			...
			remove: function() {
				...
				for (var e in this._locationWatchId !== void 0 && this.stopLocate(), this._stop(), z(this._mapPane), this._clearControlPos && this._clearControlPos(), this._resizeRequest &&= (S(this._resizeRequest), null), this._clearHandlers(), this._loaded && this.fire("unload"), this._layers) this._layers[e].remove();
			...
			_initLayout: function() {
				...
				this._fadeAnimated = this.options.fadeAnimation && I.any3d, B(e, "leaflet-container" + (I.touch ? " leaflet-touch" : "") + (I.retina ? " leaflet-retina" : "") + (I.ielt9 ? " leaflet-oldie" : "") + (I.safari ? " leaflet-safari" : "") + (this._fadeAnimated ? " leaflet-fade-anim" : ""));
				var t = Ct(e, "position");
			...
			_rawPanBy: function(e) {
				U(this._mapPane, this._getMapPanePos().subtract(e));
			},
			...
			_onResize: function() {
				S(this._resizeRequest), this._resizeRequest = x(function() {
			...
			_findEventTargets: function(e, t) {
				for (var n = [], r, i = t === "mouseout" || t === "mouseover", a = e.target || e.srcElement, s = !1; a;) {
					...
					if (r && r.listens(t, !0) && (i && !on(a, e) || (n.push(r), i)) || a === this._container) break;
					a = a.parentNode;
				}
			...
			_tryAnimatedZoom: function(e, t, n) {
				...
				return n.animate !== !0 && !this.getSize().contains(i) ? !1 : (x(function() {
					this._moveStart(!0, n.noMoveStart || !1)._animateZoom(e, t, !0);
				}, this), !0);
			},
			_animateZoom: function(e, t, n, r) {
				this._mapPane && (n && (this._animatingZoom = !0, this._animateToCenter = e, this._animateToZoom = t, B(this._mapPane, "leaflet-zoom-anim")), this.fire("zoomanim", {
					center: e,
					zoom: t,
					noUpdate: r
		...
		var Y = C.extend({
			...
			addTo: function(e) {
				...
				return B(t, "leaflet-control"), n.indexOf("bottom") === -1 ? r.appendChild(t) : r.insertBefore(t, r.firstChild), this._map.on("unload", this.remove, this), this;
			},
			remove: function() {
		...
		var dn = Y.extend({
			...
			addTo: function(e) {
				return Y.prototype.addTo.call(this, e), this._expandIfNotCollapsed();
			},
			onRemove: function() {
			...
			expand: function() {
				...
				return e < this._section.clientHeight ? (B(this._section, "leaflet-control-layers-scrollbar"), this._section.style.height = e + "px") : V(this._section, "leaflet-control-layers-scrollbar"), this._checkDisabledLayers(), this;
			},
			collapse: function() {
			...
			_initLayout: function() {
				...
				t.setAttribute("aria-haspopup", !0), $t(t), Qt(t);
			...
			_expandSafely: function() {
				var e = this._section;
				this._preventClick = !0, W(e, "click", q), this.expand();
				var t = this;
				setTimeout(function() {
					K(e, "click", q), t._preventClick = !1;
				});
			}
		}), fn = function(e, t, n) {
			return new dn(e, t, n);
			...
			_createButton: function(e, t, n, r, i) {
				var a = R("a", n, r);
				return a.innerHTML = e, a.href = "#", a.title = t, a.setAttribute("role", "button"), a.setAttribute("aria-label", t), $t(a), W(a, "click", en), W(a, "click", i, this), W(a, "click", this._refocusOnMap, this), a;
			},
			_updateDisabled: function() {
				var e = this._map, t = "leaflet-disabled";
				V(this._zoomInButton, t), V(this._zoomOutButton, t), this._zoomInButton.setAttribute("aria-disabled", "false"), this._zoomOutButton.setAttribute("aria-disabled", "false"), (this._disabled || e._zoom === e.getMinZoom()) && (B(this._zoomOutButton, t), this._zoomOutButton.setAttribute("aria-disabled", "true")), (this._disabled || e._zoom === e.getMaxZoom()) && (B(this._zoomInButton, t), this._zoomInButton.setAttribute("aria-disabled", "true"));
			}
		});
		J.mergeOptions({ zoomControl: !0 }), J.addInitHook(function() {
		...
		var mn = function(e) {
			...
			onAdd: function(e) {
				for (var t in e.attributionControl = this, this._container = R("div", "leaflet-control-attribution"), $t(this._container), e._layers) e._layers[t].getAttribution && this.addAttribution(e._layers[t].getAttribution());
		...
		J.mergeOptions({ attributionControl: !0 }), J.addInitHook(function() {
			this.options.attributionControl && new _n().addTo(this);
		}), Y.Layers = dn, Y.Zoom = pn, Y.Scale = hn, Y.Attribution = _n, un.layers = fn, un.zoom = mn, un.scale = gn, un.attribution = function(e) {
			return new _n(e);
		};
		var X = C.extend({
			initialize: function(e) {
		...
		X.addTo = function(e, t) {
			return e.addHandler(t, this), this;
		};
		var vn = { Events: w }, yn = I.touch ? "touchstart mousedown" : "mousedown", bn = oe.extend({
			options: { clickTolerance: 3 },
			initialize: function(e, t, n, r) {
				p(this, r), this._element = e, this._dragStartTarget = t || e, this._preventOutline = n;
			},
			enable: function() {
				this._enabled ||= (W(this._dragStartTarget, yn, this._onDown, this), !0);
			},
			disable: function() {
				this._enabled && (bn._dragging === this && this.finishDrag(!0), K(this._dragStartTarget, yn, this._onDown, this), this._enabled = !1, this._moved = !1);
			},
			_onDown: function(e) {
				if (this._enabled && (this._moved = !1, !Dt(this._element, "leaflet-zoom-anim"))) {
					if (e.touches && e.touches.length !== 1) {
						bn._dragging === this && this.finishDrag();
						return;
					}
					if (!(bn._dragging || e.shiftKey || e.which !== 1 && e.button !== 1 && !e.touches) && (bn._dragging = this, this._preventOutline && Ht(this._element), Rt(), Pt(), !this._moving)) {
						this.fire("down");
			...
			_onMove: function(e) {
				if (this._enabled) {
					...
					!n.x && !n.y || Math.abs(n.x) + Math.abs(n.y) < this.options.clickTolerance || (n.x /= this._parentScale.x, n.y /= this._parentScale.y, q(e), this._moved || (this.fire("dragstart"), this._moved = !0, B(document.body, "leaflet-dragging"), this._lastTarget = e.target || e.srcElement, window.SVGElementInstance && this._lastTarget instanceof window.SVGElementInstance && (this._lastTarget = this._lastTarget.correspondingUseElement), B(this._lastTarget, "leaflet-drag-target")), this._newPos = this._startPos.add(n), this._moving = !0, this._lastEvent = e, this._updatePosition());
				}
			},
			_updatePosition: function() {
				var e = { originalEvent: this._lastEvent };
				this.fire("predrag", e), U(this._element, this._newPos), this.fire("drag", e);
			},
			_onUp: function() {
				this._enabled && this.finishDrag();
			},
			finishDrag: function(e) {
				V(document.body, "leaflet-dragging"), this._lastTarget &&= (V(this._lastTarget, "leaflet-drag-target"), null), K(document, "mousemove touchmove", this._onMove, this), K(document, "mouseup touchend touchcancel", this._onUp, this), zt(), Ft();
				var t = this._moved && this._moving;
				this._moving = !1, bn._dragging = !1, t && this.fire("dragend", {
					noInertia: e,
		...
		function xn(e, t, n) {
			...
			for (a = 0, u = e.length; a < u; a++) e[a]._code = Pn(e[a], t);
			for (s = 0; s < 4; s++) {
				for (d = i[s], r = [], a = 0, u = e.length, o = u - 1; a < u; o = a++) c = e[a], l = e[o], c._code & d ? l._code & d || (f = Nn(l, c, d, t, n), f._code = Pn(f, t), r.push(f)) : (l._code & d && (f = Nn(l, c, d, t, n), f._code = Pn(f, t), r.push(f)), r.push(c));
				e = r;
			}
			return e;
		}
		function Sn(e, t) {
			...
			Z(e) || (console.warn("latlngs are not flat! Only the first ring will be used"), e = e[0]);
			var d = M([0, 0]), f = A(e);
			f.getNorthWest().distanceTo(f.getSouthWest()) * f.getNorthEast().distanceTo(f.getNorthWest()) < 1700 && (d = Cn(e));
			var p = e.length, m = [];
			for (n = 0; n < p; n++) {
				var h = M(e[n]);
		...
		function Tn(e, t) {
			...
			var n = t * t;
			return e = An(e, n), e = On(e, n), e;
		}
		function En(e, t, n) {
			return Math.sqrt(In(e, t, n, !0));
		}
		function Dn(e, t, n) {
			return In(e, t, n);
		}
		...
		function kn(e, t, n, r, i) {
			var a = 0, o, s, c;
			for (s = r + 1; s <= i - 1; s++) c = In(e[s], e[r], e[i], !0), c > a && (o = s, a = c);
			a > n && (t[o] = 1, kn(e, t, n, r, o), kn(e, t, n, o, i));
		}
		function An(e, t) {
			for (var n = [e[0]], r = 1, i = 0, a = e.length; r < a; r++) Fn(e[r], e[i]) > t && (n.push(e[r]), i = r);
			return i < a - 1 && n.push(e[a - 1]), n;
		}
		var jn;
		function Mn(e, t, n, r, i) {
			var a = r ? jn : Pn(e, n), o = Pn(t, n), s, c, l;
			for (jn = o;;) {
				if (!(a | o)) return [e, t];
				if (a & o) return !1;
				s = a || o, c = Nn(e, t, s, n, i), l = Pn(c, n), s === a ? (e = c, a = l) : (t = c, o = l);
			}
		}
		...
		function Ln(e) {
			return console.warn("Deprecated use of _flat, please use L.LineUtil.isFlat instead."), Z(e);
		}
		function Rn(e, t) {
			var n, r, i, a, o, s, c, l;
			if (!e || e.length === 0) throw Error("latlngs not passed");
			Z(e) || (console.warn("latlngs are not flat! Only the first ring will be used"), e = e[0]);
			var u = M([0, 0]), d = A(e);
			d.getNorthWest().distanceTo(d.getSouthWest()) * d.getNorthEast().distanceTo(d.getNorthWest()) < 1700 && (u = Cn(e));
			var f = e.length, p = [];
			for (n = 0; n < f; n++) {
				var m = M(e[n]);
		...
		var zn = {
			...
			closestPointOnSegment: Dn,
			clipSegment: Mn,
			_getEdgeIntersection: Nn,
			_getBitCode: Pn,
			_sqClosestPointOnSegment: In,
			isFlat: Z,
			_flat: Ln,
			polylineCenter: Rn
		}, Bn = {
		...
		N.Earth = ce, N.EPSG3395 = Un, N.EPSG3857 = fe, N.EPSG900913 = pe, N.EPSG4326 = Wn, N.Simple = Gn;
		var Q = oe.extend({
			options: {
				pane: "overlayPane",
				attribution: null,
		...
		var Qn = Xn.extend({
			...
			addHooks: function() {
				...
				this._draggable ||= new bn(e, e, !0), this._draggable.on({
					dragstart: this._onDragStart,
					predrag: this._onPreDrag,
					drag: this._onDrag,
					dragend: this._onDragEnd
				}, this).enable(), B(e, "leaflet-marker-draggable");
			},
			...
			_adjustPan: function(e) {
				...
				if (!c.contains(a)) {
					...
					n.panBy(l, { animate: !1 }), this._draggable._newPos._add(l), this._draggable._startPos._add(l), U(t._icon, this._draggable._newPos), this._onDrag(e), this._panRequest = x(this._adjustPan.bind(this, e));
				}
			},
			...
			_onPreDrag: function(e) {
				this._marker.options.autoPan && (S(this._panRequest), this._panRequest = x(this._adjustPan.bind(this, e)));
			},
			_onDrag: function(e) {
				var t = this._marker, n = t._shadow, r = Nt(t._icon), i = t._map.layerPointToLatLng(r);
				n && U(n, r), t._latlng = i, e.latlng = i, e.oldLatLng = this._oldLatLng, t.fire("move", e).fire("drag", e);
			},
			_onDragEnd: function(e) {
				S(this._panRequest), delete this._oldLatLng, this._marker.fire("moveend").fire("dragend", e);
			}
		}), er = Q.extend({
			options: {
				icon: new Qn(),
			...
			_initIcon: function() {
				...
				n !== this._icon && (this._icon && this._removeIcon(), r = !0, e.title && (n.title = e.title), n.tagName === "IMG" && (n.alt = e.alt || "")), B(n, t), e.keyboard && (n.tabIndex = "0", n.setAttribute("role", "button")), this._icon = n, e.riseOnHover && this.on({
					mouseover: this._bringToFront,
					mouseout: this._resetZIndex
				}), this.options.autoPanOnFocus && W(n, "focus", this._panOnFocus, this);
				var i = e.icon.createShadow(this._shadow), a = !1;
				i !== this._shadow && (this._removeShadow(), a = !0), i && (B(i, t), i.alt = ""), this._shadow = i, e.opacity < 1 && this._updateOpacity(), r && this.getPane().appendChild(this._icon), this._initInteraction(), i && a && this.getPane(e.shadowPane).appendChild(this._shadow);
			},
			_removeIcon: function() {
				this.options.riseOnHover && this.off({
					mouseover: this._bringToFront,
					mouseout: this._resetZIndex
				}), this.options.autoPanOnFocus && K(this._icon, "focus", this._panOnFocus, this), z(this._icon), this.removeInteractiveTarget(this._icon), this._icon = null;
			},
			_removeShadow: function() {
				this._shadow && z(this._shadow), this._shadow = null;
			},
			_setPos: function(e) {
				this._icon && U(this._icon, e), this._shadow && U(this._shadow, e), this._zIndex = e.y + this.options.zIndexOffset, this._resetZIndex();
			},
			...
			_updateOpacity: function() {
				...
				this._icon && H(this._icon, e), this._shadow && H(this._shadow, e);
			},
		...
		var sr = nr.extend({
			...
			closestLayerPoint: function(e) {
				for (var t = Infinity, n = null, r = In, i, a, o = 0, s = this._parts.length; o < s; o++) for (var c = this._parts[o], l = 1, u = c.length; l < u; l++) {
					i = c[l - 1], a = c[l];
					var d = r(e, i, a, !0);
					d < t && (t = d, n = r(e, i, a));
				}
			...
			_convertLatLngs: function(e) {
				for (var t = [], n = Z(e), r = 0, i = e.length; r < i; r++) n ? (t[r] = M(e[r]), this._bounds.extend(t[r])) : t[r] = this._convertLatLngs(e[r]);
				return t;
			},
			_project: function() {
				var e = new D();
			...
			_clipPoints: function() {
				...
				if (this._parts = [], !(!this._pxBounds || !this._pxBounds.intersects(e))) {
					...
					for (n = 0, i = 0, a = this._rings.length; n < a; n++) for (c = this._rings[n], r = 0, o = c.length; r < o - 1; r++) s = Mn(c[r], c[r + 1], e, r, !0), s && (t[i] = t[i] || [], t[i].push(s[0]), (s[1] !== c[r + 1] || r === o - 2) && (t[i].push(s[1]), i++));
				}
			},
			_simplifyPoints: function() {
				for (var e = this._parts, t = this.options.smoothFactor, n = 0, r = e.length; n < r; n++) e[n] = Tn(e[n], t);
			},
			_update: function() {
			...
			_containsPoint: function(e, t) {
				...
				for (n = 0, a = this._parts.length; n < a; n++) for (s = this._parts[n], r = 0, o = s.length, i = o - 1; r < o; i = r++) if (!(!t && r === 0) && En(e, s[i], s[r]) <= c) return !0;
				return !1;
			}
		});
		function cr(e, t) {
		...
		var lr = sr.extend({
			...
			_setLatLngs: function(e) {
				sr.prototype._setLatLngs.call(this, e), Z(this._latlngs) && (this._latlngs = [this._latlngs]);
			},
			_defaultShape: function() {
			...
			_clipPoints: function() {
				...
				if (e = new D(e.min.subtract(n), e.max.add(n)), this._parts = [], !(!this._pxBounds || !this._pxBounds.intersects(e))) {
					...
					for (var r = 0, i = this._rings.length, a; r < i; r++) a = xn(this._rings[r], e, !0), a.length && this._parts.push(a);
				}
			},
			_updatePath: function() {
		...
		function _r(e, t, n, r) {
			for (var i = [], a = 0, o = e.length; a < o; a++) i.push(t ? _r(e[a], Z(e[a]) ? 0 : t - 1, n, r) : gr(e[a], r));
		...
		er.include(br), ar.include(br), rr.include(br), sr.include({ toGeoJSON: function(e) {
			var t = !Z(this._latlngs), n = _r(this._latlngs, +!!t, !1, e);
			return vr(this, {
				type: (t ? "Multi" : "") + "LineString",
				coordinates: n
			});
		} }), lr.include({ toGeoJSON: function(e) {
			var t = !Z(this._latlngs), n = t && !Z(this._latlngs[0]), r = _r(this._latlngs, n ? 2 : +!!t, !0, e);
		...
		var Sr = xr, Cr = Q.extend({
			...
			_initImage: function() {
				...
				if (B(t, "leaflet-image-layer"), this._zoomAnimated && B(t, "leaflet-zoom-animated"), this.options.className && B(t, this.options.className), t.onselectstart = l, t.onmousemove = l, t.onload = i(this.fire, this, "load"), t.onerror = i(this._overlayOnError, this, "error"), (this.options.crossOrigin || this.options.crossOrigin === "") && (t.crossOrigin = this.options.crossOrigin === !0 ? "" : this.options.crossOrigin), this.options.zIndex && this._updateZIndex(), e) {
					this._url = t.src;
					return;
				}
			...
			_reset: function() {
				...
				U(e, t.min), e.style.width = n.x + "px", e.style.height = n.y + "px";
			},
			_updateOpacity: function() {
			...
			_initImage: function() {
				...
				if (B(t, "leaflet-image-layer"), this._zoomAnimated && B(t, "leaflet-zoom-animated"), this.options.className && B(t, this.options.className), t.onselectstart = l, t.onmousemove = l, t.onloadeddata = i(this.fire, this, "load"), e) {
		...
		var Dr = Cr.extend({ _initImage: function() {
			...
			B(e, "leaflet-image-layer"), this._zoomAnimated && B(e, "leaflet-zoom-animated"), this.options.className && B(e, this.options.className), e.onselectstart = l, e.onmousemove = l;
		} });
		function Or(e, t, n) {
			return new Dr(e, t, n);
		}
		var $ = Q.extend({
			...
			onRemove: function(e) {
				e._fadeAnimated ? (H(this._container, 0), this._removeTimeout = setTimeout(i(z, void 0, this._container), 200)) : z(this._container), this.options.interactive && (V(this._container, "leaflet-interactive"), this.removeInteractiveTarget(this._container));
			},
			getLatLng: function() {
				return this._latlng;
			},
			...
			_updatePosition: function() {
				if (this._map) {
					...
					this._zoomAnimated ? U(this._container, e.add(n)) : t = t.add(e).add(n);
		...
		var kr = $.extend({
			...
			onAdd: function(e) {
				$.prototype.onAdd.call(this, e), e.fire("popupopen", { popup: this }), this._source && (this._source.fire("popupopen", { popup: this }, !0), this._source instanceof nr || this._source.on("preclick", Zt));
			},
			onRemove: function(e) {
				$.prototype.onRemove.call(this, e), e.fire("popupclose", { popup: this }), this._source && (this._source.fire("popupclose", { popup: this }, !0), this._source instanceof nr || this._source.off("preclick", Zt));
			},
			getEvents: function() {
			...
			_initLayout: function() {
				...
				if (this._contentNode = R("div", e + "-content", n), $t(t), Qt(this._contentNode), W(t, "contextmenu", Zt), this._tipContainer = R("div", e + "-tip-container", t), this._tip = R("div", e + "-tip", this._tipContainer), this.options.closeButton) {
			...
			_updateLayout: function() {
				...
				i && r > i ? (t.height = i + "px", B(e, a)) : V(e, a), this._containerWidth = this._container.offsetWidth;
			},
			_animateZoom: function(e) {
				var t = this._map._latLngToNewLayerPoint(this._latlng, e.zoom, e.center), n = this._getAnchor();
				U(this._container, t.add(n));
			},
			_adjustPan: function() {
				if (this.options.autoPan) {
					...
					var e = this._map, t = parseInt(Ct(this._container, "marginBottom"), 10) || 0, n = this._container.offsetHeight + t, r = this._containerWidth, i = new T(this._containerLeft, -n - this._containerBottom);
		...
		J.mergeOptions({ closePopupOnClick: !0 }), J.include({
			...
			openPopup: function(e) {
				return this._popup && (this instanceof Jn || (this._popup._source = this), this._popup._prepareOpen(e || this._latlng) && this._popup.openOn(this._map)), this;
			},
			closePopup: function() {
		...
		var jr = $.extend({
			...
			_initLayout: function() {
				...
				this._contentNode = this._container = R("div", e), this._container.setAttribute("role", "tooltip"), this._container.setAttribute("id", "leaflet-tooltip-" + o(this));
			},
			_updateLayout: function() {},
			_adjustPan: function() {},
			_setPosition: function(e) {
				...
				s === "top" ? (t = c / 2, n = l) : s === "bottom" ? (t = c / 2, n = 0) : s === "center" ? (t = c / 2, n = l / 2) : s === "right" ? (t = 0, n = l / 2) : s === "left" ? (t = c, n = l / 2) : o.x < a.x ? (s = "right", t = 0, n = l / 2) : (s = "left", t = c + (u.x + d.x) * 2, n = l / 2), e = e.subtract(E(t, n, !0)).add(u).add(d), V(i, "leaflet-tooltip-right"), V(i, "leaflet-tooltip-left"), V(i, "leaflet-tooltip-top"), V(i, "leaflet-tooltip-bottom"), B(i, "leaflet-tooltip-" + s), U(i, e);
			},
			_updatePosition: function() {
			...
			setOpacity: function(e) {
				this.options.opacity = e, this._container && H(this._container, e);
			},
			_animateZoom: function(e) {
		...
		J.include({
			...
			openTooltip: function(e) {
				return this._tooltip && (this instanceof Jn || (this._tooltip._source = this), this._tooltip._prepareOpen(e) && (this._tooltip.openOn(this._map), this.getElement ? this._setAriaDescribedByOnLayer(this) : this.eachLayer && this.eachLayer(this._setAriaDescribedByOnLayer, this))), this;
			},
		...
		var Fr = Q.extend({
				...
				if (this._map && !I.ielt9) {
					...
					for (var r in this._tiles) {
						...
						if (!(!i.current || !i.loaded)) {
							...
							H(i.el, a), a < 1 ? t = !0 : (i.active ? n = !0 : this._onOpaqueTile(i), i.active = !0);
						}
					}
					n && !this._noPrune && this._pruneTiles(), t && (S(this._fadeFrame), this._fadeFrame = x(this._updateOpacity, this));
				}
			},
			_onOpaqueTile: l,
			...
			_initTile: function(e) {
				...
				e.style.width = t.x + "px", e.style.height = t.y + "px", e.onselectstart = l, e.onmousemove = l, I.ielt9 && this.options.opacity < 1 && H(e, this.options.opacity);
			},
			_addTile: function(e, t) {
				...
				this._initTile(a), this.createTile.length < 2 && x(i(this._tileReady, this, e, null, a)), U(a, n), this._tiles[r] = {
					el: a,
					coords: e,
					current: !0
			...
			_tileReady: function(e, t, n) {
				...
				n = this._tiles[r], n && (n.loaded = +/* @__PURE__ */ new Date(), this._map._fadeAnimated ? (H(n.el, 0), S(this._fadeFrame), this._fadeFrame = x(this._updateOpacity, this)) : (n.active = !0, this._pruneTiles()), t || (B(n.el, "leaflet-tile-loaded"), this.fire("tileload", {
					tile: n.el,
					coords: e
				})), this._noTilesToLoad() && (this._loading = !1, this.fire("load"), I.ielt9 || !this._map._fadeAnimated ? x(this._pruneTiles, this) : setTimeout(i(this._pruneTiles, this), 250)));
			},
		...
		var Lr = Fr.extend({
			...
			_removeTile: function(e) {
				var t = this._tiles[e];
				if (t) return t.el.setAttribute("src", y), Fr.prototype._removeTile.call(this, e);
			},
			_tileReady: function(e, t, n) {
				if (!(!this._map || n && n.getAttribute("src") === y)) return Fr.prototype._tileReady.call(this, e, t, n);
			}
		});
		function Rr(e, t) {
			return new Lr(e, t);
		...
		var zr = Lr.extend({
			...
			getTileUrl: function(e) {
				var t = this._tileCoordsToNwSe(e), n = this._crs, r = O(n.project(t[0]), n.project(t[1])), i = r.min, a = r.max, o = (this._wmsVersion >= 1.3 && this._crs === Wn ? [
					i.y,
					i.x,
					a.y,
					a.x
		...
		var Vr = Q.extend({
			...
			_updateTransform: function(e, t) {
				...
				I.any3d ? Mt(this._container, a, n) : U(this._container, a);
			},
			_reset: function() {
			...
			_destroyContainer: function() {
				S(this._redrawRequest), delete this._ctx, z(this._container), K(this._container), delete this._container;
			},
			_updatePaths: function() {
			...
			_update: function() {
				if (!(this._map._animatingZoom && this._bounds)) {
					...
					U(t, e.min), t.width = r * n.x, t.height = r * n.y, t.style.width = n.x + "px", t.style.height = n.y + "px", I.retina && this._ctx.scale(2, 2), this._ctx.translate(-e.min.x, -e.min.y), this.fire("update");
				}
			},
			_reset: function() {
			...
			_requestRedraw: function(e) {
				this._map && (this._extendRedrawBounds(e), this._redrawRequest = this._redrawRequest || x(this._redraw, this));
			},
			...
			_handleMouseOut: function(e) {
				...
				t && (V(this._container, "leaflet-interactive"), this._fireEvent([t], e, "mouseout"), this._hoveredLayer = null, this._mouseHoverThrottled = !1);
			},
			_handleMouseHover: function(e, t) {
				if (!this._mouseHoverThrottled) {
					...
					r !== this._hoveredLayer && (this._handleMouseOut(e), r && (B(this._container, "leaflet-interactive"), this._fireEvent([r], e, "mouseover"), this._hoveredLayer = r)), this._fireEvent(this._hoveredLayer ? [this._hoveredLayer] : !1, e), this._mouseHoverThrottled = !0, setTimeout(i(function() {
		...
		var Wr = (function() {
			...
			_initPath: function(e) {
				...
				B(t, "leaflet-vml-shape " + (this.options.className || "")), t.coordsize = "1 1", e._path = Wr("path"), t.appendChild(e._path), this._updateStyle(e), this._layers[o(e)] = e;
			},
			_addPath: function(e) {
				var t = e._container;
			...
			_update: function() {
				if (!(this._map._animatingZoom && this._bounds)) {
					...
					(!this._svgSize || !this._svgSize.equals(t)) && (this._svgSize = t, n.setAttribute("width", t.x), n.setAttribute("height", t.y)), U(n, e.min), n.setAttribute("viewBox", [
						e.min.x,
						e.min.y,
						t.x,
						t.y
			...
			_initPath: function(e) {
				...
				e.options.className && B(t, e.options.className), e.options.interactive && B(t, "leaflet-interactive"), this._updateStyle(e), this._layers[o(e)] = e;
			},
			_addPath: function(e) {
		...
		I.vml && qr.include(Gr);
		function Jr(e) {
			return I.svg || I.vml ? new qr(e) : null;
		}
		J.include({
		...
		qr.create = Kr, qr.pointsToPath = he, dr.geometryToLayer = fr, dr.coordsToLatLng = mr, dr.coordsToLatLngs = hr, dr.latLngToCoords = gr, dr.latLngsToCoords = _r, dr.getFeature = vr, dr.asFeature = yr, J.mergeOptions({ boxZoom: !0 });
		var Zr = X.extend({
			initialize: function(e) {
			...
			_onMouseMove: function(e) {
				this._moved || (this._moved = !0, this._box = R("div", "leaflet-zoom-box", this._container), B(this._container, "leaflet-crosshair"), this._map.fire("boxzoomstart")), this._point = this._map.mouseEventToContainerPoint(e);
				var t = new D(this._point, this._startPoint), n = t.getSize();
				U(this._box, t.min), this._box.style.width = n.x + "px", this._box.style.height = n.y + "px";
			},
			_finish: function() {
				this._moved && (z(this._box), V(this._container, "leaflet-crosshair")), Ft(), zt(), K(document, {
					contextmenu: en,
					mousemove: this._onMouseMove,
					mouseup: this._onMouseUp,
					keydown: this._onKeyDown
		...
		J.addInitHook("addHandler", "boxZoom", Zr), J.mergeOptions({ doubleClickZoom: !0 });
		var Qr = X.extend({
			addHooks: function() {
		...
		J.addInitHook("addHandler", "doubleClickZoom", Qr), J.mergeOptions({
			dragging: !0,
			inertia: !0,
		...
		var $r = X.extend({
			addHooks: function() {
				if (!this._draggable) {
					var e = this._map;
					this._draggable = new bn(e._mapPane, e._container), this._draggable.on({
						dragstart: this._onDragStart,
						drag: this._onDrag,
						dragend: this._onDragEnd
			...
			_onDragEnd: function(e) {
				...
				if (t.fire("dragend", e), r) t.fire("moveend");
					...
					!f.x && !f.y ? t.fire("moveend") : (f = t._limitOffset(f, t.options.maxBounds), x(function() {
						t.panBy(f, {
							duration: d,
							easeLinearity: o,
							noMoveStart: !0,
		...
		J.addInitHook("addHandler", "dragging", $r), J.mergeOptions({
			keyboard: !0,
			keyboardPanDelta: 80
		});
		var ei = X.extend({
		...
		J.addInitHook("addHandler", "keyboard", ei), J.mergeOptions({
			scrollWheelZoom: !0,
		...
		var ti = X.extend({
			...
			_onWheelScroll: function(e) {
				var t = an(e), n = this._map.options.wheelDebounceTime;
				...
				clearTimeout(this._timer), this._timer = setTimeout(i(this._performZoom, this), r), en(e);
			},
		...
		var ri = X.extend({
			...
			_onDown: function(e) {
				if (clearTimeout(this._holdTimeout), e.touches.length === 1) {
					...
					this._startPos = this._newPos = new T(t.clientX, t.clientY), this._holdTimeout = setTimeout(i(function() {
						this._cancel(), this._isTapValid() && (W(document, "touchend", q), W(document, "touchend touchcancel", this._cancelClickPrevent), this._simulateEvent("contextmenu", t));
			...
			_cancelClickPrevent: function e() {
				K(document, "touchend", q), K(document, "touchend touchcancel", e);
			},
			_cancel: function() {
		...
		J.addInitHook("addHandler", "tapHold", ri), J.mergeOptions({
			touchZoom: I.touch,
		...
		var ii = X.extend({
			...
			_onTouchStart: function(e) {
				...
				if (!(!e.touches || e.touches.length !== 2 || t._animatingZoom || this._zooming)) {
					...
					this._centerPoint = t.getSize()._divideBy(2), this._startLatLng = t.containerPointToLatLng(this._centerPoint), t.options.touchZoom !== "center" && (this._pinchStartLatLng = t.containerPointToLatLng(n.add(r)._divideBy(2))), this._startDist = n.distanceTo(r), this._startZoom = t.getZoom(), this._moved = !1, this._zooming = !0, t._stop(), W(document, "touchmove", this._onTouchMove, this), W(document, "touchend touchcancel", this._onTouchEnd, this), q(e);
				}
			},
			_onTouchMove: function(e) {
				if (!(!e.touches || e.touches.length !== 2 || !this._zooming)) {
					...
					this._animRequest = x(s, this, !0), q(e);
				}
			},
			_onTouchEnd: function() {
				...
				this._zooming = !1, S(this._animRequest), K(document, "touchmove", this._onTouchMove, this), K(document, "touchend touchcancel", this._onTouchEnd, this), this._map.options.zoomAnimation ? this._map._animateZoom(this._center, this._map._limitZoom(this._zoom), !0, this._map.options.zoomSnap) : this._map._resetView(this._center, this._map._limitZoom(this._zoom));
			}
		});
		J.addInitHook("addHandler", "touchZoom", ii), J.BoxZoom = Zr, J.DoubleClickZoom = Qr, J.Drag = $r, J.Keyboard = ei, J.ScrollWheelZoom = ti, J.TapHold = ri, J.TouchZoom = ii, e.Bounds = D, e.Browser = I, e.CRS = N, e.Canvas = Hr, e.Circle = ar, e.CircleMarker = rr, e.Class = C, e.Control = Y, e.DivIcon = Nr, e.DivOverlay = $, e.DomEvent = sn, e.DomUtil = Kt, e.Draggable = bn, e.Evented = oe, e.FeatureGroup = Jn, e.GeoJSON = dr, e.GridLayer = Fr, e.Handler = X, e.Icon = Xn, e.ImageOverlay = Cr, e.LatLng = j, e.LatLngBounds = k, e.Layer = Q, e.LayerGroup = Kn, e.LineUtil = zn, e.Map = J, e.Marker = er, e.Mixin = vn, e.Path = nr, e.Point = T, e.PolyUtil = wn, e.Polygon = lr, e.Polyline = sr, e.Popup = kr, e.PosAnimation = cn, e.Projection = Hn, e.Rectangle = Yr, e.Renderer = Vr, e.SVG = qr, e.SVGOverlay = Dr, e.TileLayer = Lr, e.Tooltip = jr, e.Transformation = P, e.Util = ie, e.VideoOverlay = Tr, e.bind = i, e.bounds = O, e.canvas = Ur, e.circle = or, e.circleMarker = ir, e.control = un, e.divIcon = Pr, e.extend = n, e.featureGroup = Yn, e.geoJSON = xr, e.geoJson = Sr, e.gridLayer = Ir, e.icon = Zn, e.imageOverlay = wr, e.latLng = M, e.latLngBounds = A, e.layerGroup = qn, e.map = ln, e.marker = tr, e.point = E, e.polygon = ur, e.polyline = cr, e.popup = Ar, e.rectangle = Xr, e.setOptions = p, e.stamp = o, e.svg = Jr, e.svgOverlay = Or, e.tileLayer = Rr, e.tooltip = Mr, e.transformation = de, e.version = t, e.videoOverlay = Er;
		var ai = window.L;
	...
	let t = null, n = null, r = null, i = null, a = "todas", o = null, s = null, c = !1, d = [], f = 0, p = null, m = !1, h = null, g = {}, _ = 0, v = {
		getCurrentPosition: (e, t, n) => {
			...
			} else navigator.geolocation ? navigator.geolocation.getCurrentPosition(e, t, n) : t && t(/* @__PURE__ */ Error("Geolocation not supported"));
		},
		watchPosition: (e, t, n) => {
			if (m) {
				let t = ++_;
				...
				return t;
			} else if (navigator.geolocation) return navigator.geolocation.watchPosition(e, t, n);
			return null;
		},
		clearWatch: (e) => {
			m ? delete g[e] : navigator.geolocation && navigator.geolocation.clearWatch(e);
		},
		triggerWatch: () => {
			if (m && h) {
				let e = h.getLatLng();
		...
		let i = (n - e) * Math.PI / 180, a = (r - t) * Math.PI / 180, o = Math.sin(i / 2) * Math.sin(i / 2) + Math.cos(e * Math.PI / 180) * Math.cos(n * Math.PI / 180) * Math.sin(a / 2) * Math.sin(a / 2);
		return 6371 * (2 * Math.atan2(Math.sqrt(o), Math.sqrt(1 - o)));
	}, w = (e) => e * e, oe = (e, t) => w(e.lat - t.lat) + w(e.lng - t.lng), T = (e, t, n) => {
		let r = oe(t, n);
		if (r === 0) return oe(e, t);
		let i = ((e.lat - t.lat) * (n.lat - t.lat) + (e.lng - t.lng) * (n.lng - t.lng)) / r;
		return i = Math.max(0, Math.min(1, i)), oe(e, {
			lat: t.lat + i * (n.lat - t.lat),
			lng: t.lng + i * (n.lng - t.lng)
		});
	}, se = (e, t) => {
		if (!t || t.length < 2) return Infinity;
		let n = Infinity;
		...
		a.title = "Descubrir comercios y turismo cerca", a.innerHTML = "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"20\" height=\"20\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\">\n            <path d=\"M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z\"></path><circle cx=\"12\" cy=\"13\" r=\"3\"></circle>\n        </svg>", a.style.cssText = "\n            background: rgba(15, 23, 42, 0.85);\n            border: 1px solid rgba(236, 72, 153, 0.4);\n            border-radius: 50%;\n            width: 40px; height: 40px;\n            display: flex; align-items: center; justify-content: center;\n            cursor: pointer;\n            color: #ec4899;\n            backdrop-filter: blur(10px);\n            box-shadow: 0 4px 15px rgba(0,0,0,0.3);\n            transition: all 0.2s;\n            padding: 0;\n        ", a.onmouseover = () => {
			...
			ne ? (a.style.background = "rgba(236, 72, 153, 0.3)", a.style.borderColor = "#ec4899") : (a.style.background = "rgba(15, 23, 42, 0.85)", a.style.borderColor = "rgba(236, 72, 153, 0.4)");
		}, a.onclick = (e) => {
			e && (e.preventDefault(), e.stopPropagation()), ne = !ne, ne ? (a.style.background = "rgba(236, 72, 153, 0.3)", a.style.borderColor = "#ec4899", a.style.boxShadow = "0 0 15px rgba(236, 72, 153, 0.5)", O()) : (a.style.background = "rgba(15, 23, 42, 0.85)", a.style.borderColor = "rgba(236, 72, 153, 0.4)", a.style.boxShadow = "0 4px 15px rgba(0,0,0,0.3)", te.clearLayers());
		}, i.appendChild(a);
		let o = document.createElement("div");
		o.id = "custom-zoom-capsule", o.style.cssText = "\n            background: rgba(15, 23, 42, 0.85);\n            border: 1px solid rgba(6, 182, 212, 0.4);\n            border-radius: 20px;\n            display: flex;\n            flex-direction: row;\n            height: 40px;\n            overflow: hidden;\n            backdrop-filter: blur(10px);\n            box-shadow: 0 4px 15px rgba(0,0,0,0.3);\n            pointer-events: auto;\n        ";
		let s = document.createElement("button");
		s.title = "Alejar", s.innerHTML = "<span style=\"font-size: 1.5rem; line-height: 1; margin-top: -2px;\">−</span>", s.style.cssText = "\n            background: transparent;\n            border: none;\n            border-right: 1px solid rgba(6, 182, 212, 0.25);\n            color: #06b6d4;\n            width: 40px; height: 40px;\n            cursor: pointer;\n            display: flex; align-items: center; justify-content: center;\n            font-weight: 600;\n            transition: all 0.2s;\n            padding: 0;\n        ", s.onmouseover = () => {
			s.style.background = "rgba(6, 182, 212, 0.2)";
		}, s.onmouseout = () => {
			s.style.background = "transparent";
		}, s.onclick = (e) => {
			e && (e.preventDefault(), e.stopPropagation()), t.zoomOut();
		}, o.appendChild(s);
		let c = document.createElement("button");
		c.title = "Acercar", c.innerHTML = "<span style=\"font-size: 1.5rem; line-height: 1; margin-top: -2px;\">+</span>", c.style.cssText = "\n            background: transparent;\n            border: none;\n            color: #06b6d4;\n            width: 40px; height: 40px;\n            cursor: pointer;\n            display: flex; align-items: center; justify-content: center;\n            font-weight: 600;\n            transition: all 0.2s;\n            padding: 0;\n        ", c.onmouseover = () => {
			c.style.background = "rgba(6, 182, 212, 0.2)";
		}, c.onmouseout = () => {
			...
			onAdd: function() {
				...
				return e.title = "Activar/Desactivar Simulador GPS", e.innerHTML = "<span style=\"font-size:0.7rem; font-weight:800; letter-spacing:0.5px;\">MODO PRUEBA</span>", e.style.cssText = "\n                    background: rgba(245, 158, 11, 0.9);\n                    border: 2px solid #d97706;\n                    border-radius: 8px;\n                    padding: 0.4rem 0.8rem;\n                    color: white;\n                    cursor: pointer;\n                    backdrop-filter: blur(4px);\n                    box-shadow: 0 4px 10px rgba(245, 158, 11, 0.4);\n                    transition: all 0.2s;\n                    margin-top: 10px;\n                    margin-right: 10px;\n                ", u.default.DomEvent.on(e, "click", u.default.DomEvent.stopPropagation), u.default.DomEvent.on(e, "click", () => {
					...
					} else e.style.background = "rgba(245, 158, 11, 0.9)", e.style.borderColor = "#d97706", e.innerHTML = "<span style=\"font-size:0.7rem; font-weight:800; letter-spacing:0.5px;\">MODO PRUEBA</span>", h &&= (t.removeLayer(h), null), alert("Modo Prueba Desactivado.");
				}), e;
			}
		}))().addTo(t), e.querySelector("#btn-todas").addEventListener("click", () => xe("todas")), e.querySelector("#btn-cercana").addEventListener("click", () => xe("cercana")), new IntersectionObserver((e, t) => {
			e.forEach((e) => {
				e.isIntersecting && (xe("todas"), t.unobserve(e.target));
			});
		}, { rootMargin: "200px" }).observe(r);
	}, O = () => {
			...
			e.image && (t = e.image.toLowerCase().endsWith(".png") ? u.default.divIcon({
				...
				html: `
                            <div style="width: 100%; height: 100%; display: flex; align-items: flex-end; justify-content: center; filter: drop-shadow(0px 4px 6px rgba(0,0,0,0.5));">
                                <img src="${e.image}" style="width: 100%; height: 100%; object-fit: contain; display: block;" />
                            </div>
                        `,
				iconSize: [60, 60],
				iconAnchor: [30, 60]
			...
			f.paradaData = r, f.on("click", () => {
				if (s === r) {
					i && !c ? t.fitBounds(i.getBounds(), {
						...
						animate: !0
					}) : t.flyToBounds([[r.lat, r.lon], [r.lat, r.lon]], {
						maxZoom: 17,
						paddingTopLeft: [0, 200]
					});
					return;
				}
				s = r, b &&= (clearTimeout(b), null), k(l);
				let n = () => {
					r.distance === void 0 && (r.distance = ae(o.lat, o.lon, r.lat, r.lon)), ye(o.lat, o.lon, r.lat, r.lon), s === r && N(r);
				};
				if (o ? n() : (t.flyToBounds([[r.lat, r.lon], [r.lat, r.lon]], {
					maxZoom: 17,
					paddingTopLeft: [0, 200]
				}), N(r), v.getCurrentPosition((e) => {
					o = {
					...
					timeout: 5e3,
					maximumAge: 6e4
				})), _e(r.lat, r.lon, r.name), setTimeout(() => {
					t && t.invalidateSize();
				}, 400), a === "todas") {
					let t = e.querySelector("#paradas-list-container");
					t && (t.innerHTML = "", t.appendChild(le(r)));
				}
			});
		});
	}, A = (e) => {
		let t = "";
		if (e.distance !== void 0) {
			let n = Math.max(1, Math.ceil(e.distance / .08));
			t = `<div style="font-size: 0.7rem; color: var(--brand-cyan); font-weight: 600; display: flex; align-items: center; gap: 0.3rem; margin-top: 0.15rem;"><i data-lucide="footprints" style="width:12px; height:12px;"></i> ${E(e.distance)} &bull; ${n} min a pie</div>`;
		}
		return `
            <div style="display: flex; align-items: center; gap: 0.6rem; min-width: 0; flex: 1;">
                <i data-lucide="map-pin" style="width:20px; height:20px; color: var(--brand-cyan); flex-shrink: 0;"></i>
                <div style="display: flex; flex-direction: column; min-width: 0;">
                    <strong style="color: #fff; font-size: 0.88rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${e.name}</strong>
                    <span style="color: var(--text-muted); font-size: 0.72rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${e.address}</span>
                    ${t}
                </div>
            </div>
		...
		return r.className = "pildora-hover pildora-parada", r.ontouchstart = () => {
			r.style.transform = "scale(0.98)";
		}, r.ontouchend = () => {
			r.style.transform = "scale(1)";
		}, r.innerHTML = A(n), r.addEventListener("click", () => {
			s = n, b &&= (clearTimeout(b), null), k(l);
			let r = () => {
				n.distance === void 0 && (n.distance = ae(o.lat, o.lon, n.lat, n.lon)), ye(o.lat, o.lon, n.lat, n.lon), s === n && N(n);
			};
			o ? r() : (t.flyToBounds([[n.lat, n.lon], [n.lat, n.lon]], {
				maxZoom: 17,
				paddingTopLeft: [0, 200]
			}), N(n), v.getCurrentPosition((e) => {
				o = {
					lat: e.coords.latitude,
					lon: e.coords.longitude
				}, r();
			...
			i && (i.innerHTML = "", i.appendChild(le(n))), _e(n.lat, n.lon, n.name), setTimeout(() => {
				let t = e.querySelector("#paradas");
				t && t.scrollIntoView({
					behavior: "smooth",
					block: "start"
				});
		...
		let r = document.createElement("div");
		r.className = "pildora-hover pildora-parada", r.ontouchstart = () => {
			r.style.transform = "scale(0.98)";
		}, r.ontouchend = () => {
			r.style.transform = "scale(1)";
		};
		let i = "";
		if (n.distance !== void 0) {
			let e = Math.max(1, Math.ceil(n.distance / .08));
			i = `<div style="font-size: 0.7rem; color: var(--brand-cyan); font-weight: 600; display: flex; align-items: center; gap: 0.3rem; margin-top: 0.15rem;"><i data-lucide="footprints" style="width:12px; height:12px;"></i> ${E(n.distance)} &bull; ${e} min a pie</div>`;
		}
		let a = n.nocturna ? "<span style=\"background: rgba(239, 68, 68, 0.15); color: #fca5a5; font-size: 0.6rem; font-weight: 800; padding: 0.15rem 0.4rem; border-radius: 4px; margin-left: 0.4rem; border: 1px solid rgba(239, 68, 68, 0.3); vertical-align: middle;\">NOCTURNA</span>" : "";
		return r.innerHTML = `
            <div style="display: flex; align-items: stretch; min-width: 0; flex: 1;">
                <div style="background: var(--brand-cyan); width: 60px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                    <div class="animated-sign" style="position: relative; width: 26px; height: 42px; filter: drop-shadow(0 3px 3px rgba(0,0,0,0.35)); display: flex; flex-direction: column; align-items: center;">
                        <div style="background-color: #0f172a; width: 26px; height: 32px; border-radius: 6px; padding: 2.5px; box-sizing: border-box; font-family: 'Inter', sans-serif; display: flex; flex-direction: column; z-index: 2;">
                            <div style="background-color: white; width: 100%; height: 14px; border-radius: 3.5px; display: flex; align-items: center; justify-content: center; box-sizing: border-box;">
                                <div style="color: black; font-weight: 900; font-size: 6.8px; letter-spacing: 0.8px; line-height: 1; display: block; -webkit-text-stroke: 0.2px black;">TAXI</div>
                            </div>
                ...
                <div style="display: flex; flex-direction: column; justify-content: center; min-width: 0; padding: 0.7rem 0.8rem; flex: 1;">
                    <strong style="color: #0f172a; font-size: 0.88rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; display: flex; align-items: center;">${n.name}${a}</strong>
                    <span style="color: var(--text-muted); font-size: 0.72rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${n.address}</span>
                    ${i}
                </div>
            </div>
            <div style="display: flex; align-items: center; padding-right: 0.8rem;">
                <div class="plus-icon-btn" style="background: rgba(15,23,42,0.05); border: 1px solid rgba(15,23,42,0.1); width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0; font-size: 1.1rem; font-weight: 700; color: #0f172a; transition: all 0.3s ease;">+</div>
            </div>
        `, r.addEventListener("click", () => {
			s = n, b &&= (clearTimeout(b), null), k(l), o ? (n.distance === void 0 && (n.distance = ae(o.lat, o.lon, n.lat, n.lon)), ye(o.lat, o.lon, n.lat, n.lon)) : t.flyToBounds([[n.lat, n.lon], [n.lat, n.lon]], {
				maxZoom: 17,
				paddingTopLeft: [0, 200]
			}), N(n), setTimeout(() => {
				t && t.invalidateSize();
			...
			r && (r.innerHTML = "", r.appendChild(le(n))), _e(n.lat, n.lon, n.name), setTimeout(() => {
				let t = e.querySelector("#paradas");
				t && t.scrollIntoView({
					behavior: "smooth",
					block: "start"
		...
		let n = e.querySelector("#map-overlay-info");
		if (!n) return;
		let r = [], i = "";
		if (t.distance !== void 0) {
			let e = t.distance * 1e3, n = Math.max(1, Math.round(e / 83.3)), r = n + " min";
			if (n >= 60) {
			...
			i = `
                <div style="background-color: rgba(15, 23, 42, 0.85); backdrop-filter: blur(8px); color: white; font-size: 0.75rem; font-weight: 700; padding: 0 0.75rem; height: 34px; border-radius: 9999px; display: flex; align-items: center; justify-content: center; gap: 0.3rem; white-space: nowrap; flex-shrink: 0;">
                    <i data-lucide="arrow-left-right" style="width:14px; height:14px; color: #94a3b8;"></i> ${e < 1e3 ? Math.round(e) + "m" : (e / 1e3).toFixed(1) + "km"}
                </div>${`
                <div style="background-color: rgba(15, 23, 42, 0.85); backdrop-filter: blur(8px); color: white; font-size: 0.75rem; font-weight: 700; padding: 0 0.75rem; height: 34px; border-radius: 9999px; display: flex; align-items: center; justify-content: center; gap: 0.3rem; white-space: nowrap; flex-shrink: 0;">
                    <i data-lucide="footprints" style="width:14px; height:14px; color: #94a3b8;"></i> ${r}
                </div>`}
            `;
                ...
                <div class="animated-sign animated-selected-sign" style="position: relative; width: 40px; height: 60px; display: flex; flex-direction: column; align-items: center; flex-shrink: 0; margin-right: 0.1rem;">
                    <div style="background-color: #0f172a; width: 40px; height: 48px; border-radius: 9px; display: flex; flex-direction: column; align-items: center; justify-content: flex-start; padding-top: 4px; box-shadow: 0 4px 10px rgba(0,0,0,0.15); box-sizing: border-box; z-index: 2;">
                        <div style="background-color: white; width: 32px; height: 22px; border-radius: 5.5px; display: flex; align-items: center; justify-content: center;">
                            <div style="color: black; font-family: 'Inter', sans-serif; font-weight: 900; font-size: 0.6rem; letter-spacing: 1px; line-height: 1; -webkit-text-stroke: 0.3px black;">TAXI</div>
                        </div>
                    </div>
		...
		if (!r || e.querySelector("#nav-is-arrived")) {
			t.innerHTML = `
                <div id="nav-content-inner" style="display:flex; align-items:flex-start; gap: 1rem; width: 100%;">
                    <div id="nav-icon-wrapper" data-current-icon="${o}" style="background: rgba(255,255,255,0.1); border-radius: 50%; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                        <i data-lucide="${o}" style="color: white; width: 20px; height: 20px;"></i>
                    </div>
                    <div style="display:flex; flex-direction:column; flex:1;">
                        <strong id="nav-instruction" style="font-size: 1.1rem; line-height: 1.2;">${a}</strong>
                        <span id="nav-distance" style="font-size: 0.85rem; font-weight: 800; color: #38bdf8; margin-top: 0.2rem; display: block;">${s > 0 ? s + "m" : ""}</span>
                    </div>
                </div>
            `, typeof lucide < "u" && lucide.createIcons(), n();
			return;
		...
		r && (r.style.bottom = "1.5rem");
		let i = e.querySelector("#map-overlay-banners");
		i && (i.style.display = "flex"), s && (N(s), t.flyToBounds([[s.lat, s.lon], [s.lat, s.lon]], {
			maxZoom: 17,
			paddingTopLeft: [0, 200]
		}));
	}, ge = (t, n) => {
		let r = e.querySelector("#poi-notification-container");
		r || (r = document.createElement("div"), r.id = "poi-notification-container", r.style.cssText = "position: absolute; top: 5rem; left: 50%; transform: translateX(-50%) translateY(-20px); z-index: 1100; width: 90%; max-width: 400px; display: flex; flex-direction: column; gap: 0.5rem; opacity: 0; transition: transform 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275), opacity 0.4s ease; pointer-events: none;", e.querySelector("#map").appendChild(r));
		let i = "poi-notif-" + Date.now(), a = document.createElement("div");
		a.id = i, a.style.cssText = "background: rgba(15, 23, 42, 0.85); backdrop-filter: blur(12px); border: 1px solid rgba(236, 72, 153, 0.4); border-radius: 1rem; padding: 0.8rem 1rem; color: white; display: flex; align-items: center; gap: 0.8rem; box-shadow: 0 10px 25px rgba(236, 72, 153, 0.2); pointer-events: auto;", a.innerHTML = `
            ...
            <div style="display:flex; flex-direction:column; flex:1;">
                <span style="font-size: 0.7rem; font-weight: 800; color: #ec4899; text-transform: uppercase; letter-spacing: 0.5px;">En tu ruta (A ${Math.round(n)}m)</span>
                <strong style="font-size: 0.95rem; line-height: 1.2; margin-top: 0.1rem;">${t.name}</strong>
            </div>
            <button onclick="rootElement.querySelector('#${i}').remove()" style="background: transparent; border: none; color: #94a3b8; padding: 0.2rem; cursor: pointer; display: flex; align-items: center; justify-content: center;">
                <i data-lucide="x" style="width: 18px; height: 18px;"></i>
            </button>
        `, r.appendChild(a), typeof lucide < "u" && lucide.createIcons(), requestAnimationFrame(() => {
			r.style.transform = "translateX(-50%) translateY(0)", r.style.opacity = "1";
		}), setTimeout(() => {
		...
		c = !0, re.clear(), y = {
			...
			lon: i,
			name: a
		}, document.querySelectorAll("#nav-container").forEach((e) => e.remove());
		let o = document.createElement("div");
		o.id = "nav-container", o.style.cssText = "position: absolute; bottom: 1.5rem; left: 1rem; right: 1rem; background: rgba(15, 23, 42, 0.45); backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); border-radius: 1rem; z-index: 1000; padding: 1rem; color: white; display: flex; align-items: center; justify-content: center; box-shadow: 0 10px 25px rgba(0,0,0,0.4); border: 1px solid rgba(255,255,255,0.1); transform: translateY(20px); opacity: 0; transition: transform 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275), opacity 0.4s ease;", o.innerHTML = "<i data-lucide=\"loader-2\" style=\"animation: spin 1s linear infinite; margin-right: 0.5rem;\"></i> Calculando ruta...", e.querySelector("#map").appendChild(o), typeof lucide < "u" && lucide.createIcons();
		let s = e.querySelector("#map-custom-controls");
		s && (s.style.bottom = "7.5rem"), requestAnimationFrame(() => {
			...
			if (r ? r.setLatLng([n, i]) : r = u.default.marker([n, i], { icon: ie }).addTo(t), r) {
				...
				if (e) {
					...
					t && n && (a !== null && !isNaN(a) ? (t.style.transform = `rotate(${a}deg)`, n.style.opacity = "1") : n.style.opacity = "0");
				}
			}
			if (t.fitBounds([[n, i], [n, i]], {
				maxZoom: 18,
		...
		let n = 0, r = 0, i = 0, a = [], o = 0, s = 0, c = null, l, u, d = 10 ** (t || 5);
		for (; n < e.length;) {
			c = null, o = 0, s = 0;
			do
				c = e.charCodeAt(n++) - 63, s |= (c & 31) << o, o += 5;
			while (c >= 32);
			l = s & 1 ? ~(s >> 1) : s >> 1, o = 0, s = 0;
			do
				c = e.charCodeAt(n++) - 63, s |= (c & 31) << o, o += 5;
			while (c >= 32);
			u = s & 1 ? ~(s >> 1) : s >> 1, r += l, i += u, a.push([r / d, i / d]);
		}
		return a;
	}, ye = async (n, r, a, o) => {
		try {
			let s = `https://valhalla1.openstreetmap.de/route?json=${encodeURIComponent(JSON.stringify({
				locations: [{
					lat: n,
					lon: r
				}, {
			...
			c && (d = p.maneuvers, f = 0, ee = m, me()), fe(), i = u.default.polyline(m, {
				...
				dashArray: "10, 10",
				lineJoin: "round"
			}).addTo(t), c || t.fitBounds(i.getBounds(), {
				paddingTopLeft: [20, 200],
				paddingBottomRight: [20, 20],
				animate: !0
			});
			let h = e.querySelector("#walk-info-pill");
			if (h && !c) {
				let e = l.trip.summary.length * 1e3, t = l.trip.summary.time, n = Math.max(1, Math.round(t / 60)), r = n + " min";
				if (n >= 60) {
					let e = Math.floor(n / 60), t = n % 60;
					r = t > 0 ? `${e}h ${t}min` : `${e}h`;
				}
				h.innerHTML = `<i data-lucide="navigation" style="width:14px; height:14px;"></i> A ${e < 1e3 ? Math.round(e) + " m" : (e / 1e3).toFixed(1) + " km"} <span style="opacity: 0.5; margin: 0 0.2rem;">-</span> <i data-lucide="footprints" style="width:14px; height:14px;"></i> ${r} CAMINANDO`, typeof lucide < "u" && lucide.createIcons();
			}
		} catch (e) {
			console.error("Error fetching route:", e);
		}
	}, be = () => {
		a !== "todas" || !t || s !== null || de(l);
	}, xe = (n) => {
		a = n;
		let i = e.querySelector("#btn-todas"), c = e.querySelector("#btn-cercana");
		fe(), b &&= (clearTimeout(b), null), i && i.classList.remove("active"), c && c.classList.remove("active"), n === "todas" ? (he(), s = null, i && i.classList.add("active"), ce(), k(l), P = 1, be(), r &&= (t.removeLayer(r), null), setTimeout(() => {
		...
		}, 400), t.off("moveend", be), b = setTimeout(() => {
			v.getCurrentPosition((e) => {
				if (a === "todas" && s === null && t) {
					let n = e.coords.latitude, i = e.coords.longitude;
					o = {
						lat: n,
						lon: i
		...
		}, 2e3)) : n === "cercana" && (c && c.classList.add("active"), t.off("moveend", be), setTimeout(() => {
			t && t.invalidateSize();
		}, 400), v.getCurrentPosition((n) => {
			let i = n.coords.latitude, a = n.coords.longitude;
			o = {
				lat: i,
				lon: a
			...
			Promise.all(d.map(async (e) => {
				try {
					let t = {
						...
						costing: "pedestrian",
						units: "kilometers"
					}, n = `https://valhalla1.openstreetmap.de/route?json=${encodeURIComponent(JSON.stringify(t))}`, r = await (await fetch(n)).json();
					return r.trip && r.trip.summary ? {
						...e,
						realDistance: r.trip.summary.length * 1e3
					} : {
						...e,
			...
			console.error("Error geolocating:", e), alert("No hemos podido acceder a tu ubicación. Comprueba los permisos de tu navegador."), xe("todas");
		}, { timeout: 1e4 }));
	};
	return {
		init: D,
