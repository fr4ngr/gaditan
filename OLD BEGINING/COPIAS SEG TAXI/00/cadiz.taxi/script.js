...
const translations = {
    es: {
        ...
        "nav-faq": "Preguntas",
        "nav-call": "Llama Ya",
        "hero-title": "Tu Taxi en Cádiz, <br><span class=\"gradient-text\">Al Instante</span>",
        ...
        "day-fare": "Tarifa Diurna",
        "day-fare-sub": "L-V (7h - 21h)",
        "night-fare": "Tarifa Nocturna",
        "night-fare-sub": "Noches y Festivos",
    ...
    en: {
        ...
        "nav-faq": "FAQ",
        "nav-call": "Call Now",
        "hero-title": "Your Taxi in Cádiz, <br><span class=\"gradient-text\">Instantly</span>",
        ...
        "day-fare": "Daytime Rate",
        "day-fare-sub": "Mon-Fri (7am - 9pm)",
        "night-fare": "Night & Holiday Rate",
        "night-fare-sub": "Nights & Holidays",
...
const rates = {
    day: { flag: 1.39, km: 0.70 },
    night: { flag: 1.73, km: 0.90 },
    luggage: 0.51,
    renfe: 0.82
};
...
function updatePriceUI(id) {
    ...
    // El precio de noche o festivo se estima un 25% superior
    let basePrice = (st.isDay && !st.isFestivo) ? routeData[id].base : routeData[id].base * 1.25;
    let supps = (st.luggage * rates.luggage) + (st.renfe ? rates.renfe : 0);
    
    let total = basePrice + supps;
    
    let formattedTotal = total % 1 === 0 ? total.toString() : total.toFixed(2).replace('.', ',');
