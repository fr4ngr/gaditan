...
const filePath = path.join('c:', 'Users', 'frn', 'Documents', 'cadiz.taxi', 'src', 'components', 'Reserva.astro');
let content = fs.readFileSync(filePath, 'utf8');

const target = `                <h2 class="section-title" data-translate="booking-title" itemprop="name">Reserva tu Taxi</h2>\r
                \r
                <p class="section-subtitle">Asegura tu viaje con antelación rellenando este breve formulario</p>`;

const target2 = `                <h2 class="section-title" data-translate="booking-title" itemprop="name">Reserva tu Taxi</h2>\n                \n                <p class="section-subtitle">Asegura tu viaje con antelación rellenando este breve formulario</p>`;

const replacement = `                <div style="display: flex; justify-content: center; margin-bottom: 2.5rem; width: 100%;">
