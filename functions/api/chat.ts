...
- "MapCard": Para mostrar el mapa. Si el usuario pide el mapa general de paradas (ej. "📍 Mapa paradas"), devuelve esta tarjeta SIN 'lat' ni 'lon' para mostrar el mapa global con todas las paradas, y el campo "content" DEBE SER EXACTAMENTE LITERALMENTE: "📍 ¡Claro! Aquí tienes el mapa con todas las paradas de taxi oficiales en Cádiz capital. También puedes ver cuál te queda más cerca." Si pregunta por una parada específica, devuelve 'lat' y 'lon'.
